...
export default function Information(props) {
    ...
    return (
        <Grid container className={classes.container} spacing={4} justify="center">
            ...
            {/* BOENDE CARD */}
            <Grid item xs={12} md={6} xl={3} align="center">
                ...
                <Card className={classes.cards} align="left">
                    ...
                    <CardActions>
                        <ThemeProvider theme={theme}>
                            <Button href="https://dsek.se" target="_blank" size="large" color="secondary" variant="outlined" startIcon={<LinkIcon/>}>
                                DSEK.SE
                            </Button>
                        </ThemeProvider>
                    </CardActions>
            ...
            <Grid item xs={12} md={6}  xl={3} align="center">
                <Card className={classes.cards} align="left">
                    ...
                    <CardActions>
                        <ThemeProvider theme={theme}>
                            <Button href="https://tlth.se" target="_blank" size="large" color="primary" variant="outlined" startIcon={<LinkIcon/>}>
                                TLTH.SE
                            </Button>
                        </ThemeProvider>
                    </CardActions>
